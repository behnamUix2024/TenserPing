...
package com.behnamuix.tenserpingx.util

import ir.myket.billingclient.util.Base64DecoderException
...
object Base64 {
    ...
    const val ENCODE: Boolean = true

    /** Specify decoding (value is `false`).  */
    const val DECODE: Boolean = false
    ...
    private fun encode3to4(
        ...
        val inBuff =
            ((if (numSigBytes > 0) ((source[srcOffset].toInt() shl 24) ushr 8) else 0)
    ...
    fun encode(
        ...
        while (d < len2) {
            ...
            val inBuff =
                (((source[d + off].toInt() shl 24) ushr 8)
    ...
    private fun decode4to3(
        ...
        if (source[srcOffset + 2] == EQUALS_SIGN) {
            val outBuff =
                (((decodabet[source[srcOffset].toInt()].toInt() shl 24) ushr 6)
